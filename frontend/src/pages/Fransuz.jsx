...
const Fransuz = () => {
  ...
  return (
    <div>
      ...
      ></section>
      <Category />
      <h1 className="text-center text-5xl text-base-content font-bold my-6">
        Fransiya
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center  px-4">
        {fransuz
          ...
          .map((food) => (
            <div
              key={food.id}
              className="card w-[350px] md:w-[400px] bg-base-100 shadow-2xl"
            >
                ...
                <div className="mb-2">
                  <div className="flex items-center gap-2 md:gap-3 mb-1">
                    ...
                    <p className="text-lg md:text-2xl">
                      <strong>{food.cook_time}</strong> daqiqa
                    </p>
                  </div>
