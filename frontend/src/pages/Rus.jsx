...
import r from '../assets/russia_banner.png'
...
getRussia()
  ...
  return (
    <div>
      ...
      ></section>
    <Category/>
      <h1 className="text-center text-5xl text-base-content font-bold my-6">Rossiya</h1>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center  px-4">
        {russia
          ?.filter(food => food.category === "russian")
          .map((food) => (
