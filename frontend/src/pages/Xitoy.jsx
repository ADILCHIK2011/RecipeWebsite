...
import xitoy_banner from '../assets/xitoy_banner.png'
...
getXitoy()
  ...
  return (
    <div>
      <Navbar />
      <section
        style={{ backgroundImage: `url(${xitoy_banner})` }}
        className="bg-no-repeat bg-cover bg-center w-full h-[450px]"
      ></section>
    <Category/>
      <h1 className="text-center text-5xl text-base-content font-bold my-6">XITOY</h1>
